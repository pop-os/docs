...
- [What is Pop!_OS?](introduction/what-is-pop.md)
    - [Introduction to COSMIC & the Pop!\_Shell](introduction/cosmic-shell-intro.md)
    - [Pop!_OS Development Roadmap](introduction/pop-development-roadmap.md)
    - [Contribute to Pop!_OS](introduction/contribute-to-pop.md)
...
- [Hardware Management](hardware-management/hardware-management.md)
    - [Video (Display)]()
        ...
        - [Color Profiles]()
    - [Audio](hardware-management/sound/sound.md)
        - [Sound Architecture](hardware-management/sound/sound-architecture.md)
        - [Sound Settings](hardware-management/sound/speaker-and-microphone-settings.md)
        - [Audio Troubleshoting](hardware-management/sound/audio-troubleshooting.md)
        - [Audio Enhancement](hardware-management/sound/audio-apps.md)
    - [Printers](hardware-management/printers.md)
    - [Webcams & Capture Cards](hardware-management/webcams-and-capture-cards.md)
    - [Input Devices]()
